 ...
 */
final class Version20220704224326 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE boisson CHANGE taille libelle VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE boisson CHANGE libelle taille VARCHAR(255) NOT NULL');
    }
}
